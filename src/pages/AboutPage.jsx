...
export default function AboutPage() {
  ...
  return (
    <div style={{ background: 'var(--cream)', minHeight: '100vh', paddingTop: isMobile ? '80px' : '30px' }}>
      {/* Hero */}
      <section style={{ 
        background: 'var(--navy)', 
        ...
        <h1 style={{ 
          fontFamily: "'Cormorant Garamond', serif", 
          fontSize: isMobile ? 'clamp(28px, 7vw, 42px)' : 'clamp(42px, 7vw, 82px)', 
          fontWeight: 600, 
          color: '#fff', 
          lineHeight: 1.2, 
          margin: '0 auto 20px', 
      ...
      <section style={{ 
        ...
        <h2 style={{ 
          ...
          marginBottom: '20px',
          fontFamily: "'Cormorant Garamond', serif" 
        }}>Built by travelers, for travelers.</h2>
        <p style={{ 
          color: 'var(--text-mid)', 
          fontSize: isMobile ? '15px' : '17px', 
          lineHeight: 1.7 
